...
class ComponentWithExtendsLayout extends Component
{
    ...
    {
        return ws_view('null-view')->extends('layouts.app-extends', [
            'bar' => 'baz'
        ]);
    }
}
...
class ComponentWithCustomSection extends Component
{
    ...
    public function render()
    {
        return ws_view('show-name')->extends('layouts.app-custom-section')->section('body');
    }
}
...
class ComponentWithCustomLayout extends Component
{
    public function render()
    {
        return ws_view('null-view')->layout('layouts.app-with-bar', [
            'bar' => 'baz'
        ]);
    }
}
...
class ComponentWithCustomSlotForLayout extends Component
{
    ...
    public function render()
    {
        return ws_view('show-name')->layout('layouts.app-custom-slot')->slot('main');
    }
}
...
class ComponentWithClassBasedComponentLayout extends Component
{
    public function render()
    {
        return ws_view('null-view')->layout(\Tests\AppLayout::class, [
            'bar' => 'baz'
        ]);
    }
}
...
class ComponentWithClassBasedComponentLayoutAndParams extends Component
{
    public function render()
    {
        return ws_view('null-view')->layout(\Tests\AppLayoutWithConstructor::class, [
            'bar' => 'baz'
        ]);
    }
}
...
class ComponentWithAnonymousComponentLayout extends Component
{
    public function render()
    {
        return ws_view('null-view')->layout('layouts.app-anonymous-component', [
            'bar' => 'baz'
        ]);
    }
}
...
class ComponentWithCustomParams extends Component
{
    public function render()
    {
        return ws_view('null-view')->layoutData([
            'slot' => 'foo'
        ]);
    }
}
...
class ComponentWithCustomParamsAndLayout extends Component
{
    public function render()
    {
        return ws_view('null-view')->layout('layouts.data-test')->layoutData([
            'title' => 'livewire',
        ]);
    }
}
