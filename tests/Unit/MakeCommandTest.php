...
class MakeCommandTest extends TestCase
{
    ...
    public function new_component_class_view_name_reference_matches_configured_view_path()
    {
        ...
        $this->app['config']->set('livewire.view_path', ws_resource_path('views/not-livewire'));
        ...
        $this->assertTrue(File::exists(ws_resource_path('views/not-livewire/foo.blade.php')));
    }
