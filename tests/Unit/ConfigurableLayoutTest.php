...
class ConfigurableLayoutTest extends TestCase
{
    ...
    {
        ws_config()->set('livewire.layout', 'layouts.app-with-baz-hardcoded');
    ...
    {
        ws_config()->set('livewire.layout', AppLayout::class);
    ...
    {
        ws_config()->set('livewire.layout', 'layouts.app-anonymous-component');
    ...
    {
        ws_config()->set('livewire.layout', 'layouts.app-anonymous-component-with-required-prop');
...
class ComponentForConfigurableLayoutTestWithCustomParams extends Component
{
    ...
    public function render()
    {
        return ws_view('show-name')->layoutData([
            'bar' => 'baz',
        ]);
    }
}
...
class ComponentForConfigurableLayoutTestWithCustomSlot extends Component
{
    ...
    public function render()
    {
        return ws_view('show-name')->slot('bar');
    }
}
