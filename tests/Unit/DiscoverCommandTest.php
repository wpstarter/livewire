...
class ToBeDiscovered extends Component {
    public function render() { return ws_view('livewire.to-be-discovered'); }
}
EOT
        );
...
EOT
        ...
        $output = ws_view('render-component', [
    ...
    {
        $manifestPath = ws_app()->bootstrapPath('cache/livewire-components.php');
    ...
    public function no_exception_is_thrown_when_the_class_directory_does_not_exist()
    {
        ...
        $this->assertTrue(File::exists(ws_app()->bootstrapPath('cache/livewire-components.php')));
    }
}
