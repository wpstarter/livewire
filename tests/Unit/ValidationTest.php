...
use WpStarter\Contracts\Validation\Rule;
...
class ValidationTest extends TestCase
{
    ...
    public function validate_nested_component_properties()
    {
        ...
        if (version_compare(ws_app()->version(), '10', '>=')) {
    ...
    public function validation_errors_are_shared_for_all_views()
    {
        ...
        ws_app('view')->share('errors', $errors = new ViewErrorBag);
        ...
        $this->assertTrue(ws_app('view')->shared('errors') === $errors);
    }
...
class ForValidation extends Component
{
    ...
    {
        return ws_app('view')->make('dump-errors');
    }
}
