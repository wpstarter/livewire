...
class NestingComponentsTest extends TestCase
{
    ...
    {
        ws_app('livewire')->component('parent', ParentComponentForNestingChildStub::class);
        ws_app('livewire')->component('child', ChildComponentForNestingStub::class);
        $component = ws_app('livewire')->test('parent');
    ...
    {
        ws_app('livewire')->component('parent', ParentComponentForNestingChildrenStub::class);
        ws_app('livewire')->component('child', ChildComponentForNestingStub::class);
        $component = ws_app('livewire')->test('parent');
    ...
    {
        ws_app('livewire')->component('parent', ParentComponentForNestingChildrenWithWireKeyStub::class);
        ws_app('livewire')->component('child', ChildComponentForNestingStub::class);
        $component = ws_app('livewire')->test('parent');
    ...
    {
        ws_app('livewire')->component('parent', ParentComponentForNestingChildrenWithWireKeyHavingCommaStub::class);
        ws_app('livewire')->component('child', ChildComponentForNestingStub::class);
        $component = ws_app('livewire')->test('parent');
    ...
    {
        ws_app('livewire')->component('parent', ParentComponentForSkipRenderStub::class);
        ws_app('livewire')->component('child', ChildComponentForNestingStub::class);
        $component = ws_app('livewire')->test('parent');
...
class ParentComponentForNestingChildStub extends Component
{
    ...
    {
        return ws_app('view')->make('show-child', [
            'child' => ['name' => 'foo'],
        ]);
    }
}
...
class ParentComponentForNestingChildrenStub extends Component
{
    ...
    public function render()
    {
        return ws_app('view')->make('show-children', [
...
class ChildComponentForNestingStub extends Component
{
    ...
    public function render()
    {
        return ws_app('view')->make('show-name-with-this');
    }
}
