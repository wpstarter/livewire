...
class ComponentsAreSecureTest extends TestCase
{
    ...
    public function throws_method_not_found_exception_when_action_missing()
    {
        ...
        ws_app('livewire')->component('security-target', SecurityTargetStub::class);
        $component = ws_app('livewire')->test('security-target');
    ...
    public function component_name_cannot_be_tampered_with_on_frontend()
    {
        ...
        ws_app('livewire')->component('safe', SecurityTargetStub::class);
        ws_app('livewire')->component('unsafe', UnsafeComponentStub::class);
        $component = ws_app('livewire')->test('safe');
