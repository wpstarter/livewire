...
class EloquentModelValidationTest extends TestCase
{
    ...
    {
        ws_app('translator')->addLines(['validation.required' => 'The :attribute field is required.'], 'en');
        ws_app('translator')->addLines(['validation.attributes.foo.bar' => 'plop'], 'en');
    ...
    public function collection_model_property_validation_only_includes_relevant_error()
    {
        Livewire::test(ComponentForEloquentModelCollectionHydrationMiddleware::class, [
            'foos' => ws_collect()->pad(3, Foo::first()),
        ])
