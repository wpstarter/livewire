...
class Test extends TestCase
{
    public function test_route_bound_properties_are_synced_with_browser_history()
    {
        $this->browse(function (Browser $browser) {
            $browser->visit(ws_route('sync-history', ['step' => 1], false))
    ...
    {
        $this->browse(function(Browser $browser) {
            $browser->visit(ws_route('sync-history-without-query-string', [ 'step' => 1 ], false))->waitForText('Step 1 Active');
    ...
    {
        $this->browse(function (Browser $browser) {
            $browser->visit(ws_route('sync-history-without-mount', ['id' => 1], false))
    ...
    {
        $this->browse(function(Browser $browser) {
            $browser->visit(ws_route('sync-history-with-optional-parameter', [], false))
