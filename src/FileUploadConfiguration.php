...
class FileUploadConfiguration
{
    ...
    public static function disk()
    {
        ...
        return ws_config('livewire.temporary_file_upload.disk') ?: ws_config('filesystems.default');
    }

    public static function diskConfig()
    {
        return ws_config('filesystems.disks.'.static::disk());
    }

    public static function isUsingS3()
    {
        $diskBeforeTestFake = ws_config('livewire.temporary_file_upload.disk') ?: ws_config('filesystems.default');

        return ws_config('filesystems.disks.'.strtolower($diskBeforeTestFake).'.driver') === 's3';
    }
    ...
    public static function isUsingGCS()
    {
        ...
        return ws_config('filesystems.disks.'.strtolower($diskBeforeTestFake).'.driver') === 'gcs';
    }
    ...
    {
        return static::normalizeRelativePath(ws_config('livewire.temporary_file_upload.directory') ?: 'livewire-tmp');
    }
    ...
    {
        return ws_config('livewire.temporary_file_upload.middleware') ?: 'throttle:60,1';
    }

    public static function rules()
    {
        $rules = ws_config('livewire.temporary_file_upload.rules');
    ...
    {
        return ws_config('livewire.temporary_file_upload.max_upload_time') ?: 5;
    }
}
