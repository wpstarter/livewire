...
class DuskBrowserMacros
{
    ...
    public function assertScript()
    {
        return function ($js, $expects = true) {
            /** @var \Laravel\Dusk\Browser $this */
            PHPUnit::assertEquals($expects, ws_head($this->script(
                str($js)->start('return ')
            )));
    ...
    public function waitForLivewire()
    {
        return function ($callback = null) {
            ...
            return new class($this, $id) {
                ...
                {
                    return ws_tap($this->browser->{$method}(...$params), function ($browser) {
    ...
    public function online()
    {
        return function () {
            /** @var \Laravel\Dusk\Browser $this */
            return ws_tap($this)->script("window.dispatchEvent(new Event('online'))");
        };
    }
    ...
    public function offline()
    {
        return function () {
            /** @var \Laravel\Dusk\Browser $this */
            return ws_tap($this)->script("window.dispatchEvent(new Event('offline'))");
        };
    }
