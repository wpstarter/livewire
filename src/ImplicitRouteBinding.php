...
/**
 * This class mirrors the functionality of Laravel's WpStarter\Routing\ImplicitRouteBinding class.
 */
class ImplicitRouteBinding
{
    ...
    public function getPublicPropertyTypes($component)
    {
        ...
        return ws_collect($component->getPublicPropertiesDefinedBySubClass())
