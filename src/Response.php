...
class Response
{
    ...
    {
        return ws_tap($this)->embedIdInHtml();
    }
    ...
    public function toSubsequentResponse()
    {
        ...
        foreach (ws_data_get($this, 'effects.dirty', []) as $property) {
            $property = ws_head(explode('.', $property));

            ws_data_set($dirtyMemo, 'data.'.$property, $responseMemo['data'][$property] ?? null);
        }
