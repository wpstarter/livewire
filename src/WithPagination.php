...
trait WithPagination
{
    ...
    public function initializeWithPagination()
    {
        ...
        if (class_exists(CursorPaginator::class)) {
            CursorPaginator::currentCursorResolver(function ($pageName){
                if (! isset($this->paginators[$pageName])) {
                    $this->paginators[$pageName] = ws_request()->query($pageName, '');
                }
        ...
        Paginator::currentPageResolver(function ($pageName) {
            if (! isset($this->paginators[$pageName])) {
                $this->paginators[$pageName] = ws_request()->query($pageName, 1);
            }
    ...
    public function resolvePage()
    {
        ...
        return ws_request()->query(ws_data_get($this->queryString, 'page.as', 'page'), $this->page);
    }
}
