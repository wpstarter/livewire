...
class SupportComponentTraits
{
    ...
    function __construct()
    {
        Livewire::listen('component.boot', function ($component) {
            foreach (ws_class_uses_recursive($component) as $trait) {
                $hooks = [
                    'boot',
                    'hydrate',
                    'mount',
                ...
                foreach ($hooks as $hook) {
                    $method = $hook.ws_class_basename($trait);
            ...
            foreach ($methods as $method) {
                ImplicitlyBoundMethod::call(ws_app(), $method);
            }
        });
        ...
        Livewire::listen('component.mount', function ($component, $params) {
            ...
            foreach ($methods as $method) {
                ImplicitlyBoundMethod::call(ws_app(), $method, $params);
            }
        });
        ...
        Livewire::listen('component.booted', function ($component, $request) {
            ...
            foreach ($methods as $method) {
                ImplicitlyBoundMethod::call(ws_app(), $method, [$request]);
            }
        });
        ...
        Livewire::listen('component.updating', function ($component, $name, $value) {
            ...
            foreach ($methods as $method) {
                ImplicitlyBoundMethod::call(ws_app(), $method, [$name, $value]);
            }
        });
        ...
        Livewire::listen('component.rendered', function ($component, $view) {
            ...
            foreach ($methods as $method) {
                ImplicitlyBoundMethod::call(ws_app(), $method, [$view]);
            }
        });
